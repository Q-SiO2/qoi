...
class _ProfLoginPageState extends State<ProfLoginPage> {
  ...
  Future<void> login() async {
    ...
    final url = Uri.parse("https://qoi.onrender.com/accounts/prof-login/");
    ...
    if (response.statusCode == 200) {
      ...
      await prefs.setString("professor_id", data["id"].toString());
      await prefs.setString("professor_email", data["email"]);
